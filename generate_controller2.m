...
% disp('Done 5');
% u = simplify(u);
% u = simplify(LgLfy\simplify(psi(y, Lfy) - Lf2y));
matlabFunction(LgLfy, 'File', 'LgLfy', 'vars', [q1 q2 q3 dq1 dq2 dq3]);
disp('Done 5');
matlabFunction(psi, 'File', 'psi_func', 'vars', [q1 q2 q3 dq1 dq2 dq3]);
disp('Done 6');
matlabFunction(Lf2y, 'File', 'Lf2y', 'vars', [q1 q2 q3 dq1 dq2 dq3]);
disp('Done 7');
