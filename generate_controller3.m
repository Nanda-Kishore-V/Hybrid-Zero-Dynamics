...
% theta = q1;
% Lfth = simplify(jacobian(theta, [qs; qsdot])*f);
% Lf2th = simplify(jacobian(Lfth, [qs; qsdot])*f);
% LgLfth = simplify(jacobian(Lfth, [qs; qsdot])*g);
...
matlabFunction(Lfy, 'File', 'Lfy_hybrid', 'vars', [q1 q2 q3 dq1 dq2 dq3]);
matlabFunction(LgLfy, 'File', 'LgLfy_hybrid', 'vars', [q1 q2 q3 dq1 dq2 dq3]);
matlabFunction(Lf2y, 'File', 'Lf2y_hybrid', 'vars', [q1 q2 q3 dq1 dq2 dq3]);
% matlabFunction(LgLfth, 'File', 'LgLfth', 'vars', [q1 q2 q3 dq1 dq2 dq3]);
% matlabFunction(Lf2th, 'File', 'Lf2th', 'vars', [q1 q2 q3 dq1 dq2 dq3]);
end
